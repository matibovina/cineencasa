...
public class Principal {
	...
	//Creacion instancia de Cine
		...
		cine.setPeliculaReproduciendo(nuevaPelicula.peliculas[0].getTituloPelicula()); //Asignacion del titulo de la pelicula al Cine
...
/*
	...
	- En la mayoria de los casos se utilice constructores por defecto ya que no podia llamar al atributo de otra forma que no sea con el setAbc(Abc) 
	como se podra ver en las distintas clases.
